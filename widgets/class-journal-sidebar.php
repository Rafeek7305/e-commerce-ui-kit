...
class Journal_Sidebar extends Widget_Base
{
	public function get_name()
	{
		return 'handzom_journal_sidebar';
	}

	public function get_title()
	{
		return esc_html__('Journal Sidebar', 'handzom-ui-kit');
	}
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_categories',
			[
				'label' => esc_html__('Block 3 — Categories', 'handzom-ui-kit'),
			]
		);
		...
		// ==========================================
		// BLOCK 4: LATEST ARTICLES
		// ==========================================
		$this->start_controls_section(
			'section_latest_articles',
			[
				'label' => esc_html__('Block 4 — Latest Articles', 'handzom-ui-kit'),
			]
		);
		...
		$this->add_control(
			'order_categories',
			[
				'label' => esc_html__('Categories Order', 'handzom-ui-kit'),
				'type' => Controls_Manager::NUMBER,
				'default' => 3,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#F4F1EB',
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#222222',
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar, {{WRAPPER}} .handzom-journal-sidebar__desc, {{WRAPPER}} .handzom-journal-sidebar__story-desc' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#66615A',
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__date, {{WRAPPER}} .handzom-journal-sidebar__number' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'color_category_link',
			[
				'label' => esc_html__('Category Link Color', 'handzom-ui-kit'),
				'type' => Controls_Manager::COLOR,
				'default' => '#333333',
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__cat-link' => 'color: {{VALUE}};',
				],
			]
		);

		$this->add_control(
			'color_category_link_hover',
			[
				'label' => esc_html__('Category Link Color (Hover)', 'handzom-ui-kit'),
				'type' => Controls_Manager::COLOR,
				'default' => '#000000',
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__cat-link:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#222222',
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#D9D5CE',
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__section:not(:last-child)' => 'border-bottom-color: {{VALUE}};',
					'{{WRAPPER}} .handzom-journal-sidebar__divider' => 'border-top-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .handzom-journal-sidebar__title',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .handzom-journal-sidebar__desc, {{WRAPPER}} .handzom-journal-sidebar__story-desc',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .handzom-journal-sidebar__link',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .handzom-journal-sidebar__article-title',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .handzom-journal-sidebar__date',
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'typo_category',
				'label' => esc_html__('Categories Font', 'handzom-ui-kit'),
				'selector' => '{{WRAPPER}} .handzom-journal-sidebar__cat-link',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .handzom-journal-sidebar',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar' => 'box-shadow: 0px 4px 20px rgba(0,0,0,0.05);',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar.is-sticky' => 'position: sticky; top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__section' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__section:not(:last-child)' => 'border-bottom-style: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'condition' => ['enable_dividers' => 'yes'],
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__section:not(:last-child)' => 'border-bottom-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__list' => 'display: flex; flex-direction: column; gap: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .handzom-journal-sidebar__item' => 'margin-bottom: 0;', // reset old margin
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__number' => 'min-width: {{SIZE}}{{UNIT}}; display: inline-block;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__link' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__number' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__link:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__link:hover .handzom-journal-sidebar__number' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__item.is-active .handzom-journal-sidebar__link' => 'color: {{VALUE}}; font-weight: 600;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__item.is-active .handzom-journal-sidebar__number' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__image-wrap' => 'aspect-ratio: 100 / {{SIZE}};',
					'{{WRAPPER}} .handzom-journal-sidebar__img' => 'height: 100%; object-fit: cover;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__image-wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; overflow: hidden;',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .handzom-journal-sidebar__button',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__button' => 'color: {{VALUE}}; border-bottom-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__button:hover' => 'color: {{VALUE}}; border-bottom-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__article-img-wrap' => 'flex: 0 0 {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; aspect-ratio: 1/1;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__article-img-wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__article' => 'gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__articles-list' => 'gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__input' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__input' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => ['px'],
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__input' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#111111',
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__submit' => 'background-color: {{VALUE}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#FFFFFF',
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__submit' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#333333',
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__submit:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => ['px'],
				'selectors' => [
					'{{WRAPPER}} .handzom-journal-sidebar__submit' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render()
	{
		...
		if ($settings['enable_journal_block'] === 'yes') {
			ob_start();
			?>
			<div class="handzom-journal-sidebar__section handzom-journal-sidebar__nav">
				<?php if (!empty($settings['journal_title'])): ?>
					<h4 class="handzom-journal-sidebar__title"><?php echo esc_html($settings['journal_title']); ?></h4>
				<?php endif; ?>

				<?php if (!empty($settings['journal_items'])): ?>
					<ul class="handzom-journal-sidebar__list">
						<?php foreach ($settings['journal_items'] as $item):
							...
							?>
							<li class="handzom-journal-sidebar__item <?php echo esc_attr($is_active); ?>">
								<a href="<?php echo $link_url; ?>" <?php echo $target . $nofollow; ?> class="handzom-journal-sidebar__link">
									<?php if (!empty($item['item_number'])): ?>
										<span class="handzom-journal-sidebar__number"><?php echo esc_html($item['item_number']); ?></span>
									<?php endif; ?>
									<span class="handzom-journal-sidebar__text"><?php echo esc_html($item['item_text']); ?></span>
								</a>
							</li>
						<?php endforeach; ?>
					</ul>
		...
		if ($settings['enable_our_story'] === 'yes') {
			ob_start();
			?>
			<div class="handzom-journal-sidebar__section handzom-journal-sidebar__story">
				<?php if (!empty($settings['story_title'])): ?>
					<h4 class="handzom-journal-sidebar__title"><?php echo esc_html($settings['story_title']); ?></h4>
				<?php endif; ?>

				<?php if (!empty($settings['story_image']['url'])): ?>
					<div class="handzom-journal-sidebar__image-wrap">
						<img src="<?php echo esc_url($settings['story_image']['url']); ?>"
							alt="<?php echo esc_attr($settings['story_title']); ?>" class="handzom-journal-sidebar__img">
					</div>
				<?php endif; ?>

				<?php if (!empty($settings['story_description'])): ?>
					<div class="handzom-journal-sidebar__desc">
				...
				<?php if (!empty($settings['story_button_text'])):
					...
					?>
					<a href="<?php echo $link_url; ?>" <?php echo $target . $nofollow; ?> class="handzom-journal-sidebar__button">
						<?php echo esc_html($settings['story_button_text']); ?>
						<?php if ($settings['story_button_arrow'] === 'yes'): ?>
							<span class="handzom-journal-sidebar__arrow">→</span>
						<?php endif; ?>
					</a>
				<?php endif; ?>
			</div>
		...
		if ($settings['enable_categories'] === 'yes') {
			...
			?>
			<div class="handzom-journal-sidebar__section handzom-journal-sidebar__categories">
				<?php if (!empty($settings['categories_title'])): ?>
					<h4 class="handzom-journal-sidebar__title"><?php echo esc_html($settings['categories_title']); ?></h4>
				<?php endif; ?>

				<?php if (!empty($categories)): ?>
					<ul class="handzom-journal-sidebar__cat-list">
						<?php foreach ($categories as $category): ?>
							<li class="handzom-journal-sidebar__cat-item">
								<a href="<?php echo esc_url(get_category_link($category->term_id)); ?>" class="handzom-journal-sidebar__cat-link">
			...
			<?php
			$blocks[$settings['order_categories']] = ob_get_clean();
		}
		...
		if ($settings['enable_latest_articles'] === 'yes') {
			ob_start();
			?>
			<div class="handzom-journal-sidebar__section handzom-journal-sidebar__articles">
				<?php if (!empty($settings['articles_title'])): ?>
					<h4 class="handzom-journal-sidebar__title"><?php echo esc_html($settings['articles_title']); ?></h4>
				<?php endif; ?>

				<div class="handzom-journal-sidebar__articles-list">
					<?php
					if ($settings['articles_source'] === 'posts') {
						...
						if ($query->have_posts()) {
							while ($query->have_posts()) {
								$query->the_post();
								?>
								<a href="<?php the_permalink(); ?>" class="handzom-journal-sidebar__article">
									<?php if (has_post_thumbnail()): ?>
										<div class="handzom-journal-sidebar__article-img-wrap">
											<?php the_post_thumbnail('thumbnail', ['class' => 'handzom-journal-sidebar__article-img']); ?>
										</div>
									<?php endif; ?>
									<div class="handzom-journal-sidebar__article-content">
										<h5 class="handzom-journal-sidebar__article-title"><?php the_title(); ?></h5>
										<span class="handzom-journal-sidebar__date"><?php echo get_the_date(); ?></span>
									</div>
								</a>
								<?php
							}
						...
						if (!empty($settings['manual_articles'])) {
							foreach ($settings['manual_articles'] as $article) {
								...
								?>
								<a href="<?php echo $link_url; ?>" <?php echo $target . $nofollow; ?> class="handzom-journal-sidebar__article">
									<?php if (!empty($article['article_image']['url'])): ?>
										<div class="handzom-journal-sidebar__article-img-wrap">
											<img src="<?php echo esc_url($article['article_image']['url']); ?>"
												...
												class="handzom-journal-sidebar__article-img">
										</div>
									<?php endif; ?>
									<div class="handzom-journal-sidebar__article-content">
										<?php if (!empty($article['article_title'])): ?>
											<h5 class="handzom-journal-sidebar__article-title"><?php echo esc_html($article['article_title']); ?>
											</h5>
										<?php endif; ?>
										<?php if (!empty($article['article_date'])): ?>
											<span class="handzom-journal-sidebar__date"><?php echo esc_html($article['article_date']); ?></span>
										<?php endif; ?>
									</div>
								</a>
								<?php
		...
		if ($settings['enable_stay_loop'] === 'yes') {
			ob_start();
			?>
			<div class="handzom-journal-sidebar__section handzom-journal-sidebar__newsletter">
				<?php if (!empty($settings['loop_title'])): ?>
					<h4 class="handzom-journal-sidebar__title"><?php echo esc_html($settings['loop_title']); ?></h4>
				<?php endif; ?>
				...
				<form class="handzom-journal-sidebar__form" action="<?php echo esc_url($settings['loop_form_action']); ?>"
					method="POST">
					<input type="email" name="email" class="handzom-journal-sidebar__input"
						placeholder="<?php echo esc_attr($settings['loop_placeholder']); ?>" required>
					<button type="submit" class="handzom-journal-sidebar__submit">
		...
		<div class="handzom-journal-sidebar">
			<?php
